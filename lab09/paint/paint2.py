...
def setsurf():
    ...
    tr1 = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\paint\\img\\right_triangle.png")
    buttons.blit(tr1, (8, 8))
    tr2 = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\paint\\img\\equilateral-triangle.png")
    buttons.blit(tr2, (8, 55))
    pg.draw.rect(buttons, 'black', (58, 10, 32, 32), 2)
    rh = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\paint\\img\\rhombus.png")
