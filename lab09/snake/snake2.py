...
bg = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\img\\background.jpg")
bg = pg.transform.scale(bg, (w, h))
gameover = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\img\\game_over.jpg")
...
class Food:
    ...
    def draw2(self):
        ...
        self.y = randrange(0, h, step)
        self.r = randint(1, 3)
        self.image = pg.image.load(f'C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\img\\food{self.r}.png')
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pg.image.load("C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\img\\wall.png")
...
s = Snake()
f = Food(pg.image.load(f'C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\img\\food{randint(1,3)}.png'))
disappear(5000)
...
while is_running:
    ...
    my_walls = open(f'C:\\Users\\Lenovo\\OneDrive\\Рабочий стол\\PP II\\lab09\\snake\\wall{level}.txt', 'r').readlines() # читает каждую линию как отдельный лист
    walls = []
